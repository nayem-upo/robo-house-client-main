...
const Carousel = () => {
    return (
        <div className='flex flex-col-reverse md:flex-row md:mx-auto max-w-[1100px] md:my-20 mx-10'>
            <div data-aos="fade-right" className='md:w-1/2 md:pe-10'>
            ...
            <div data-aos="fade-left" className='md:w-1/2 my-10 md:my-0'>
